...
public interface IFutureRestApi {
	 ...
	 *            this_week:当周 next_week:下周 month:当月 quarter:季度
	 * @return
	 */
	...
	// * @throws IOException
	// */
	// public String future_index(String symbol) throws HttpException,
	// IOException;
	//
	// /**
	// * 期货交易记录
	...
	// * @throws IOException
	// */
	// public String future_trades(String symbol,String contractType) throws
	...
	// * @throws IOException
	// */
	// public String future_depth(String symbol,String contractType) throws
	// HttpException, IOException;
	//
	// /**
	// * 汇率查询
	...
	// * @throws IOException
	// */
	// public String future_cancel(String symbol,String contractType,String
	// orderId) throws HttpException, IOException;
	//
	// /**
	// * 期货下单
	// * @param symbol btc_usd:比特币 ltc_usd :莱特币
	...
	// * @throws IOException
	// */
	// public String future_trade(String symbol,String contractType,String
	// price,String amount,String type,String matchPrice) throws HttpException,
	// IOException;
	//
	//
	// /**
	...
	// * @throws IOException
	// */
	// public String future_position(String symbol,String contractType) throws
	// HttpException, IOException;
	//
	// /**
	// * 用户逐仓持仓查询
	...
	// * @throws IOException
	// */
	// public String future_order_info(String symbol,String contractType,String
	// orderId,String status,String currentPage,String pageLength) throws
	// HttpException, IOException;
	//
